...
We take this helpful assistant and ask it to play the role of an (imperfect) actor. The decisions made in the development of the script generation process focus on maintaining and even encouraging the emerging [mistakes and slip ups](https://www.notion.so/The-Models-2025-dmstfctn-1f9ae824ec58801d9aa4ee1a40ddbf48?pvs=21), and in this we were primarily guided by what is surprising and unexpected.